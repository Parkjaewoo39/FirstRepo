...
namespace WhatisInterface
{
    public class WhatisCollection
    {
        public void CollectionDesc() 
        {
             ...
             * 배열은 크기가 고정되어 있다. 배열은 크기가 고정되어 있어 새로운 데이터를
        ...
        struct Node 
        {
            ...
            //(데이터 삽입과 삭제될때 씀.)
            //선형구조- 한줄로 연결되어있다.
            //Next와Prev가 둘다 있으면 Double Linked list
            //Prev가 없고 Next만 있으면 Single LInked list
        }   //Node가 하나의 갈고리와 고리를 가진 연결체 이런게 여러게면 Licked list
    }   //WhatisCollection
}
