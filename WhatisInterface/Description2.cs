...
{
    public class Description2   //OOP
    {
        public void ObjectOrientedProramming() 
        {
            /**
             * 절차지향적 프로그래밍(메인에 모든것을 적어버리는것)
             * 찾기 힘듬
             * 
             * C#은 객체 지향 프로그래밍이라는 캡슐화, 상속, 다형성, 추상화 등 개념을
             * 제공한다.
             * 
             * 객체 지향 프로그래밍 소개하기
             ...
             * 
             * 객체 지향 프로그래밍 이라는 것은 학술적인 의미를 가지는 것이며, 만능은 아니다.
             * 
             ...
             * 
             * 다형성
             * 특정 클래스의 메서드는 매게변수에 따라 여러 가지 다양한 형태일 수 있다.
             * 즉, 이러한 클래스의 특징을 다형성이라고 한다.(메서드는 오버로딩 할 수 있다.)
             */
        }       //ObjectOrientedProramming()
    }
}
